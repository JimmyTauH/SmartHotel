/*
 ...
 Source Schema         : hotelms

 Target Server Type    : MySQL
 Target Server Version : 80035 (8.0.35)
 File Encoding         : 65001

 Date: 30/10/2024 19:34:20
*/
...
CREATE TABLE `activity`  (
  ...
  `address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '竞赛地址',
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '竞赛' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `circulars` VALUES (34, 7, '您的帖子<a href=\"/front/blogDetail?blogId=10\" target=\"_blank\" style=\"color: blue;\">《花筑·麦社民宿》</a>有了新的回复：酒店的房型非常丰富', '新的回复', '2024-10-12 19:39:59', 0);
...
CREATE TABLE `collect`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '收藏' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `comment`  (
  ...
  `module` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '模块',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 114 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '评论表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `likes`  (
  ...
  `module` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '模块',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '点赞' ROW_FORMAT = DYNAMIC;
...
-- Records of service
-- ----------------------------
INSERT INTO `service` VALUES (1, '设施维护通知', '尊敬的宾客，酒店将在2024年10月15日至17日期间对部分公共设施进行维护。期间可能会有短暂影响，敬请谅解。', '2023-09-05', 9, 1);
INSERT INTO `service` VALUES (2, '停车服务温馨提示', '尊敬的宾客，酒店提供有限停车位，先到先得。请您在抵达前与酒店确认车位情况，感谢您的配合。', '2024-06-09', 9, 1);
INSERT INTO `service` VALUES (3, '早餐服务调整通知', '尊敬的宾客，为优化服务体验，酒店早餐时间调整为每天6:30至10:00。早餐供应地点为一楼餐厅，感谢您的理解与支持。', '2024-06-09', 9, 2);
INSERT INTO `service` VALUES (4, '入住时间及退房时间', '尊敬的宾客，酒店的入住时间为下午14:00，退房时间为中午12:00。如需延迟退房，请提前告知前台，具体费用按酒店政策执行。', '2024-06-10', 8, 2);
INSERT INTO `service` VALUES (13, '房间清洁', '111', '2024-09-30T16:00:00.000Z', 9, 1);
...
INSERT INTO `user` VALUES (9, 'gygy', '123456', 'gygy', NULL, 'USER', NULL, NULL, NULL, NULL, NULL, 0);
