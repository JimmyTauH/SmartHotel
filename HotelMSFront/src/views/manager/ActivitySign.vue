  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="activityId" label="酒店ID" show-overflow-tooltip></el-table-column>
        <el-table-column prop="activityName" label="酒店名称" show-overflow-tooltip></el-table-column>
